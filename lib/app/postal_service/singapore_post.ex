defmodule App.PostalService.SingaporePost do
  import Meeseeks.CSS

  def obtain_events(tracking_code) do
    url = String.replace(url, "$TRACKING_CODE", tracking_code)

    {:ok, %{body: body}} = HTTPoison.get(url, [], [timeout: 50000, recv_timeout: 50000])
  ...
  defp url do
    "https://track-chinapost.com/result_global.php?code=$TRACKING_CODE"
  end
end
